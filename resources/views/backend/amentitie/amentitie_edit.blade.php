                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.amentitie') }}" class="forms-sample" id="myForm">
                                @csrf
                                <input type="hidden" name="id" value="{{ $amentitie->id }}">
                                <div class="mb-3">
                                    <label for="" class="form-label">Amentities Name</label>
                                    <input type="text" class="form-control" name="amenitis_name" autocomplete="off"
                                        id="amenitis_name" value="{{ $amentitie->amenitis_name }}">
